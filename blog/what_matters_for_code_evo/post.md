...
When working on a project I find it useful to run very simple baselines as sanity checks. ML has a long history of simple methods either working surprisingly well [@salimans2017evolution;@mania2018simple;@sutton2019bitter;@gulrajani2020search] or showing that our intuitions are misguided [@adebayo2018sanity;@ferrari2019we;@chen2021exploring]. A few months back I was working on a project trying to build on AlphaEvolve [@novikov2025alphaevolve] and ran some random search baselines. Lo and behold, the baselines and AlphaEvolve performed equally well. This was unexpected -- why would something you can code up in a few hours match methods that are far more developed?
